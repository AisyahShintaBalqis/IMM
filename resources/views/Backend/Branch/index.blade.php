...
<div class="container mx-auto px-4">
    <div class="card-body">  
        ...
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-semibold">Daftar Cabang</h2>
        ...
        <table class="table-auto w-full border-collapse border border-gray-200">
            <thead class="bg-gray-100">
                <tr>
                    <th class="border px-4 py-2 text-left">Nama Cabang</th>
                    <th class="border px-4 py-2 text-left">Kabupaten/Kota</th>
                    <th class="border px-4 py-2 text-left">Ketua Cabang</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border px-4 py-2">{{ $item->regency }}</td>
